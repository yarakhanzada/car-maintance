...
class TechnicianBottombar extends StatelessWidget {
  final TechNavigationController controller = Get.put(TechNavigationController());
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          decoration: BoxDecoration(color: Colors.black.withOpacity(0.6), borderRadius: const BorderRadius.only(topLeft: Radius.circular(25), topRight: Radius.circular(25)), border: Border.all(color: Colors.white.withOpacity(0.08))),
          child: ClipRRect(
                ...
                child: Obx(
                  () => GNav(
                    ...
                    tabs: const [
                      ...
                      GButton(icon: Icons.build_circle_rounded, text: 'قيد التنفيذ'),
